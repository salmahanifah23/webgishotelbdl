      ...
      <header class="header black-bg">
        <div class="sidebar-toggle-box">
          <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
        <a href="index.php" class="logo"><b>WebGIS Hotel (26-1811523010 Salma Hanifah)</b></a>
        <div class="top-menu">
            ...
            <div class="col-lg-12 main-chart"> 
             <div class="col-sm-12">
                <div class="col-sm-6"> <!-- information -->
                    ...
                    <section class="panel">
                      <header class="panel-heading">
                        <h4 class="box-title" style="text-transform:capitalize;"><b>Information</b></h4>
                      </header>
                      <?php 
                       require '../connect.php';
                        $id = $_GET["idgallery"];
                      ...
                      ?>
                      <table class="table">
                        <thead><th>Date</th><th class="centered">Information</th></thead>
                      <?php  
                  ...
                  <div class="row">
                    <div class="col-sm-12"> <!-- gallery -->
                      <section class="panel">
                          ...
                          <a class="btn btn-compose" style="background-color:black;border-bottom:1px solid black;color:white">Gallery</a>
                              ...
                              <div class="html5gallery" style="max-height:700px; display:block;"
                                <?php
                    ...
                    <div class="col-sm-12"> <!-- peta -->
                      ...
                      <header class="panel-heading" style="float:left">
                            ...
                            <a class="btn btn-success" role="button" data-toggle="collapse" onclick="posisisekarang()" title="Current Position"><i class="fa fa-location-arrow" style="color:black;"></i></a>
                            <a class="btn btn-success" role="button" data-toggle="collapse" onclick="lokasimanual()" title=" Manual Position"><i class="fa fa-map-marker" style="color:black;"></i></a>
                            <label id="tombol">
                            <a class="btn btn-success" role="button" id="showlegenda" data-toggle="collapse" onclick="legenda()" title="Legend"><i class="fa fa-eye" style="color:black;"></i></a></label>
